...
public abstract class DataReader {
	...
	public DataReader(Set<String> searchCriteria, SearchType searchType) {
		if (searchCriteria == null || searchType == null)
			throw new NullPointerException("Neither field 'searchCriteria' nor field 'searchType' can be null in a reader.DataReader object");
	...
	public DataReader(SearchParameters searchParameters) {
		if (searchParameters == null)
			throw new NullPointerException("You cannot instantiate a reader.DataReader object for null as 'searchParameters'");
	...
	public void setSearchCriteria(Set<String> searchCriteria) {
		if (searchCriteria == null)
			throw new NullPointerException("Field 'searchCriteria' cannot be null in a reader.DataReader object");
		this.searchCriteria = searchCriteria;
	}
	...
	public void setSearchType(SearchType searchType) {
		if (searchType == null)
			throw new NullPointerException("Field 'searchType' cannot be null in a reader.DataReader object");
		this.searchType = searchType;
	}
	...
	public void setSearchParameters(SearchParameters searchParameters) {
		if (searchParameters == null)
			throw new NullPointerException("Parameter 'searchParameters' cannot be null when setting fields of a reader.DataReader object");
		this.searchCriteria = searchParameters.getSearchCriteria();
		this.searchType = searchParameters.getSearchType();
	}
	...
	public Set<Person> getPersons(SearchParameters searchParameters) throws ReaderException {
		if (searchParameters == null)
			throw new NullPointerException("You cannot invoke reader.DataReader.getPersons with null as 'searchParameters'");
